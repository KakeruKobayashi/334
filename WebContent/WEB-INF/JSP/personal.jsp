	...
	<div>
		...
		<form action="personalController" method="post">
			...
			<div class="form-group">
				...
				<input type="date" name="calender" min="1900-01-01" max="2023-12-31" class="form-input">
				<br>
				<br>
				...
				<br>
				<br>
				<input class="form-input" type="text" name="year" pattern="[0-9]{4}" required maxlength="4" placeholder="yyyy">
				<input class="form-input" type="text" name="month" pattern="[0-9]{2}" required maxlength="2" placeholder="mm">
				<input class="form-input" type="text" name="day" pattern="[0-9]{2}" required maxlength="2" placeholder="dd">
			</div>
