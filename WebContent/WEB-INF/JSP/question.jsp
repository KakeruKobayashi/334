...
<body>
	...
	<div>
    	<form action="questionController" method="post">
    		<div class="radio-container">
        		...
        		<div id="options1" style="display: none;">
            		<label>
            			<input type="radio" name="genre" value="TOEIC">
            			<span>
            				TOEIC
            			</span>
            		</label>
            		<br>
            		<label>
            		<input type="radio" name="genre" value="TOEFL">
            		<span>
            			TOEFL
            		</span>
            	</label>
            	<br>
            	<label>
            		<input type="radio" name="genre" value="GTEC">
            		<span>
            			GTEC
            		</span>
            	</label>
        ...
        <div class="radio-container">
        	<label for="showOptions2" class="custom-radio-container">
        		<span>
        			漢字
        		</span>
        ...
        <br>
		<div class="radio-container">
        	<label for="showOptions3" class="custom-radio-container">
        		<span>
        			会計
        		</span>
        	...
        	<div id="options3" style="display: none;">
            	<label>
            		<input type="radio" name="genre" value="会計">
            		<span>
            			日商簿記1級
            		</span>
            	</label>
        ...
        <div class="radio-container">
        	<label for="showOptions4" class="custom-radio-container">
        		<span>
        			情報
        		</span>
        	...
        	<div id="options4" style="display: none;">
            	<label>
            		<input type="radio" name="genre" value="プログラミング">
            		<span>
            			プログラミング
            		</span>
            	</label>
            	<br>
            	<label>
            		<input type="radio" name="genre" value="MOS">
            		<span>
            			MOS
            		</span>
            	</label>
		...
		<br>
		<div class="radio-container">
        	<label for="showOptions5" class="custom-radio-container">
        		<span>
        			マーケティング
        		</span>
        	...
        	<div id="options5" style="display: none;">
            	<label>
            		<input type="radio" name="genre" value="マーケティング入門">
            		<span>
            			Webマーケティング入門
            		</span>
            	</label>
            	<br>
            	<label>
            		<input type="radio" name="genre" value="マーケティング応用">
            		<span>
            			Webマーケティング応用
            		</span>
            	</label>
		...
		<div class="radio-container">
        	<label for="showOptions7" class="custom-radio-container">
        		<span>
        			データ分析
        		</span>
        	...
        	<div id="options7" style="display: none;">
            	<label>
            		<input type="radio" name="genre" value="データ分析入門">
            		<span>
            			データ分析入門
            		</span>
            	</label>
            	<br>
            	<label>
            		<input type="radio" name="genre" value="データ分析応用">
            		<span>
            			データ分析応用
            		</span>
            	</label>
        ...
        <br>
		<div class="radio-container">
        	<label for="showOptions8" class="custom-radio-container">
        		<span>
        			マネジメント
        		</span>
        	...
        	<div id="options8" style="display: none;">
            	<label>
            		<input type="radio" name="genre" value="マネジメント入門">
            		<span>
            			マネジメント入門
            		</span>
            	</label>
            	<br>
            	<label>
            		<input type="radio" name="genre" value="マネジメント応用">
            		<span>
            			マネジメント応用
            		</span>
            	</label>
